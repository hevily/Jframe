	 ...
	 *    } );
        ...
        var DataTable = function (oInit) {
            ...
            function _fnColumnOptions(oSettings, iCol, oOptions) {
                ...
                oCol.fnGetData = function (oData, sSpecific) {
                    ...
                    var dataKey = typeof oCol.mData === 'string' ? oCol.mData : '';
                    if (oCol.mRender && (sSpecific && sSpecific !== '')) {
                        return mRender(innerData, sSpecific, oData, dataKey);
                    }
                    return innerData;
                };
            ...
            function _fnAddData(oSettings, aDataSupplied) {
                ...
                for (var i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                    ...
                    if (oCol._bAutoType && oCol.sType != 'string' && false) {
            ...
            function _fnGetObjectDataFn(mSource) {
                if (mSource === null) {
                    ...
                    return function (data, type, extra, addons) {
                        return mSource(data, type, extra, addons);
                    };
             ...
             *  @memberof DataTable#oApi
             */
            function _fnDraw(oSettings, fireRowCallBack, primaryData) {
                /* Provide a pre-callback function which can be used to cancel the draw is false is returned */
                if (!oSettings._loadCountInfo) {
                ...
                if (oSettings.aiDisplay.length !== 0) {
                    ...
                    for (var j = iStart; j < iEnd; j++) {
                        ...
                        fireRowCallBack || _fnCallbackFire(oSettings, 'aoRowCallback', null, [nRow, oSettings.aoData[ oSettings.aiDisplay[j] ]._aData, iRowCount, j]);
                        anRows.push(nRow);
                        iRowCount++;
                ...
                if (oSettings.nTBody && !oSettings._loadCountInfo) {
                ...
                delete oSettings._loadCountInfo;

                /* Call all required callback functions for the end of a draw */
                _fnCallbackFire(oSettings, 'aoDrawCallback', 'draw', [oSettings, primaryData]);
                ...
                if (oSettings.oFeatures.bServerSide) {
                    ...
                    if (!oSettings._bInitComplete) {
                        _fnInitComplete(oSettings, primaryData);
                    }
                }
            }
             ...
             *  @memberof DataTable#oApi
             */
            function _fnReDraw(oSettings, noCurpage) {
                if (oSettings.oFeatures.bSort) {
                    /* Sorting will refilter and draw for us */
                    _fnSort(oSettings, oSettings.oPreviousSearch, noCurpage);
            ...
            function _fnAjaxUpdateDraw(oSettings, json) {
                var primaryData = json
                json = Pzoom.Tool.dataTableValidate(oSettings, json);
                var pagingFn;
                if (!json) {
                    return;
                }
                if (!json.aoData && json.paging) {
                    pagingFn = function (oSettings) {
                        DataTable.ext.oPagination[ oSettings.sPaginationType ].fnUpdate(oSettings, function (oSettings) {
                            _fnCalculateEnd(oSettings);
                            _fnDraw(oSettings, null, primaryData);
                        });
                    };
                    // user
                    // oSettings.aoDrawCallback[0].fn.apply( oSettings.oInstance, [oSettings] );
                    // server_side_sort_classes
                    // oSettings.aoDrawCallback[1].fn.apply( oSettings.oInstance, [oSettings] );
                    // scrolling
                    // oSettings.aoDrawCallback[2].fn.apply( oSettings.oInstance, [oSettings] );
                    // information
                    // oSettings.aoDrawCallback[3].fn.apply( oSettings.oInstance, [oSettings] );
                    // pagination
                    // oSettings.aoDrawCallback[4].fn.apply( oSettings.oInstance, [oSettings] );
                    // FixedHeader
                    // oSettings.aoDrawCallback[5].fn.apply( oSettings.oInstance, [oSettings] );
                    // user
                    oInit.fnDrawCallback.apply(oSettings.oInstance, [oSettings, primaryData]);
                    // information
                    _fnUpdateInfo.apply(oSettings.oInstance, [oSettings]);
                    // pagination
                    pagingFn.apply(oSettings.oInstance, [oSettings])
                    delete oSettings._loadCountInfo;
                    return;
                }
                if (!oSettings._loadCountInfo) {
                    oSettings._iRecordsTotal = typeof json.iTotalRecords !== 'undefined' ? parseInt(json.iTotalRecords, 10) : oSettings._iRecordsTotal;
                    oSettings._iRecordsDisplay = typeof json.iTotalDisplayRecords !== 'undefined' ? parseInt(json.iTotalDisplayRecords, 10) : oSettings._iRecordsDisplay;
                        ...
                        process: function (item) {
                            if (bReOrder) {
                                ...
                                for (var j = 0, jLen = oSettings.aoColumns.length; j < jLen; j++) {
                                    aDataSorted.push(item[ aiIndex[j] ]);
                                }
                                _fnAddData(oSettings, aDataSorted);
                            } else {
                                _fnAddData(oSettings, item);
                            }
                        },
                        callback: function () {
                           if(oSettings.destroy){return false}
            ...
            function _fnUpdateInfo(oSettings) {
                ...
                if (!oSettings.oFeatures.bInfo || oSettings.aanFeatures.i.length === 0 || ((oSettings._iRecordsTotal === -1 || oSettings._iRecordsDisplay === -1) && oSettings._isGetCountInfo)) {
                    return;
                }
            ...
            function _fnFeatureHtmlLength(oSettings) {
                ...
                $('select', nLength).bind('change.DT', function (e) {
                    ...
                    //静态翻页后切换显示长度，导致bug；@20131113 lqy
                    //oSettings._iDisplayStart = 0;
                    _fnDraw(oSettings);
                });
            ...
            function _fnFeatureHtmlTable(oSettings) {
                 ...
                 *          tfoot - nTfoot
                 */
                // oSettings.nTable.style['tableLayout'] = 'fixed';
                ...
                if (oSettings.oScroll.sX !== "") {
                    ...
                    $(nScrollBody).scroll(function (e) {
                        ...
                        $(nScrollHead).find(".selectTips").css("margin-left", this.scrollLeft)//-$(oSettings.nTableWrapper).offset().left-$(nScrollHead).offset().left+1)
                        if (nTfoot !== null) {
            ...
            function _fnScrollDraw(o) {
                ...
                var nScrollHeadInner = o.nScrollHead.getElementsByTagName('div')[0], nScrollHeadTable = nScrollHeadInner.getElementsByTagName('table')[0], nScrollBody = o.nTable.parentNode, i, iLen, j, jLen, anHeadToSize, anHeadSizers, anFootSizers, anFootToSize, oStyle, iVis, nTheadSize, nTfootSize, iWidth, aApplied = [], aAppliedFooter = [], iSanityWidth, nScrollFootInner = (o.nTFoot !== null) ? o.nScrollFoot.getElementsByTagName('div')[0] : null, nScrollFootTable = (o.nTFoot !== null) ? nScrollFootInner.getElementsByTagName('table')[0] : null, ie67 = o.oBrowser.bScrollOversize, zeroOut = function (nSizer) {
                    ...
                    oStyle.paddingLeft = "0";
                    oStyle.paddingRight = "0"
                ...
                if (parseInt(o.nTable.style.width) < $(nScrollBody).width()) {
                    o.nTable.style.width = '100%';
                }
                 ...
                 */
                iSanityWidth = $(nScrollHeadInner).outerWidth();
                if (false) {
                ...
                var iOuterWidth = $(o.nTHead).outerWidth();
            ...
            function _fnCalculateColumnWidths(oSettings) {
                ...
                if (iColums == oHeaders.length && iUserInputs === 0 && iVisibleColumns == iColums && oSettings.oScroll.sX === "" && oSettings.oScroll.sY === "") {
                     ...
                     */
                    iCorrector = 0;
                    $(oSettings.nTHead).parent().css('tableLayout', 'auto');
                    var columnsLen = oSettings.aoColumns.length;
                    for (i = 0; i < columnsLen; i++) {
                        if (oSettings.aoColumns[i].bVisible) {
                            if (!oSettings.aoColumns[i].sWidth || oSettings.aoColumns[i].sWidth === '0px') {
                                iWidth = $(oNodes[iCorrector]).width();
                                if (iWidth !== null && iWidth > 0) {
                                    oSettings.aoColumns[i].sWidth = _fnStringToCss(iWidth);
                                    oSettings.aoColumns[i].sWidthOrig = oSettings.aoColumns[i].sWidth;
                                }
                            }
                            iCorrector++;
                        }
                    ...
                    var viewWidth = $(oSettings.nTHead).outerWidth();
                    oSettings.nTable.style.width = viewWidth + 'px';
                    nCalcTmp.parentNode.removeChild(nCalcTmp);
                    $(oSettings.nTHead).parent().css('tableLayout', 'fixed');
                    var tableEle = $(oSettings.nTable).css('tableLayout', 'fixed'), headEle = $(oSettings.nTHead).clone(), ths, thLen, styleObj, i;
                    headEle.find('> tr').not(':eq(0)').remove();
                    ths = headEle.find('> tr')[0].childNodes;
                    thLen = ths.length;
                    for (i = 0; i < thLen; i++) {
                        ths[i].innerHTML = '';
                        styleObj = ths[i].style;
                        styleObj.paddingTop = 0;
                        styleObj.paddingBottom = 0;
                        styleObj.borderTopWidth = 0;
                        styleObj.borderBottomWidth = 0;
                        styleObj.height = 0;
                    }
                    tableEle.find('> thead').remove();
                    tableEle.prepend(headEle);
                }
                if (widthAttr) {
                    oSettings.nTable.style.width = _fnStringToCss(widthAttr);
                }
                oSettings.nTable.isOverflow = $(oSettings.nTBody).width() > viewWidth;
                _fnCallbackFire(oSettings, 'aoCustomCallback', null, null);
            }
             ...
             *  @memberof DataTable#oApi
             */
            function _fnSort(oSettings, bApplyClasses, noPage) {
            ...
            function _fnCallbackFire(oSettings, sStore, sTrigger, aArgs) {
                ...
                for (var i = aoStore.length - 1; i >= 0; i--) {
                    if (typeof aoStore[i].fn == "function") {
                        if (aArgs) {
		 ...
		 *    } );
            ...
            this.fnAdjustColumnSizing = function (bRedraw) {
                ...
                $(oSettings.nTable.parentNode).scroll();
            };
            /**
		 ...
		 *    } );
             */
            this.fnDraw = function (bComplete, noCurpage, fireRowCallBack) {
                var oSettings = _fnSettingsFromNode(this[DataTable.ext.iApiIndex]);
                if (bComplete === false) {
                    _fnCalculateEnd(oSettings);
                    _fnDraw(oSettings, fireRowCallBack);
                } else {
                    if (!noCurpage) {
                        oSettings._iDisplayStart = 0;
                    }
                    _fnReDraw(oSettings, noCurpage);
                }
		 ...
		 *    } );
            ...
            this.each(function () {
                ...
                _fnCallbackReg(oSettings, 'aoCustomCallback', oInit.fnCustomCallback, 'user');

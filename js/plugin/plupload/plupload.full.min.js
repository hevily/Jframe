...
// convert plupload features to caps acceptable by mOxie
    ...
    var plupload = {
        ...
        cleanName: function (name) {
            ...
            // Replace diacritics
            lookup = [
                /[\300-\306]/g, 'A', /[\340-\346]/g, 'a', /\307/g, 'C', /\347/g, 'c', /[\310-\313]/g, 'E', /[\350-\353]/g, 'e', /[\314-\317]/g, 'I', /[\354-\357]/g, 'i', /\321/g, 'N', /\361/g, 'n', /[\322-\330]/g, 'O', /[\362-\370]/g, 'o', /[\331-\334]/g, 'U', /[\371-\374]/g, 'u'
            ];
    ...
    /*plupload.addFileFilter('image_box_array', function (image_box_array, file, cb) {
        if (file.type != "image/png" && file.type != "image/jpg") {
            ...
            img.onload = function () {
                ...
                if (image_box_array.length && image_box_array.indexOf(c) == -1) {
                    self.trigger('Error', {
                        code: plupload.IMAGE_SIZE_ERROR,
                        message: plupload.translate('Image size error.'),
                        file: file
                    });
                    cb(false)
                } else {
    ...
    plupload.Uploader = function (options) {
            ...
            function _setOption(option, value, init) {
                ...
                switch (option) {
                    case 'max_file_size':
                        ...
                        break;
                    /*case 'image_box_array':
                        settings.image_box_array = settings.filters.image_box_array = value;
                        break;*/
                    case 'chunk_size':
        ...
        plupload.extend(this, {
            ...
            addFile: function (file, fileName) {
                ...
                if (queue.length) {
                    o.inSeries(queue, function () {
                        //self.trigger("AllFiltered",files);
